...
contract SupplyAvaxBorrowUsdcBenqi is Script {
    ...
    uint256 constant COLLATERAL_AMOUNT = 1e16;
    ...
    function run() external {
        ...
        IERC20(WAVAX_TOKEN_REMOTE).approve(WAVAX_TOKEN_REMOTE, COLLATERAL_AMOUNT);
        IERC20TokenTransferrer(WAVAX_TOKEN_REMOTE).sendAndCall(input, COLLATERAL_AMOUNT);
        vm.stopBroadcast();
    }
}

// forge script --rpc-url $COQ_RPC_URL script/SupplyAvaxBorrowUsdcBenqi.s.sol:SupplyAvaxBorrowUsdcBenqi --skip-simulation --broadcast
